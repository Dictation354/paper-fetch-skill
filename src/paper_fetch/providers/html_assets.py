...
extract_scoped_html_assets = _asset_impl.extract_scoped_html_assets
...
html_asset_is_supplementary = _asset_impl.html_asset_is_supplementary
...
split_body_and_supplementary_assets = _asset_impl.split_body_and_supplementary_assets
supplementary_response_block_reason = _asset_impl.supplementary_response_block_reason
...
def download_supplementary_assets(*args, **kwargs):
    kwargs.setdefault("cookie_opener_builder", _build_cookie_seeded_opener)
    kwargs.setdefault("opener_requester", _request_with_opener)
    return _asset_impl.download_supplementary_assets(*args, **kwargs)
