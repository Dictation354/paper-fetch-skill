...
def test_caption_formula_cannot_consume_the_next_springer_figure():
    html = """
    <article><div class="c-article-body"><div class="main-content"><section data-title="Results">
    <h2>Results</h2><figure><img src="https://example.test/Fig1.png" alt="Figure 1">
    <figcaption>Figure 1. First result.</figcaption>
    <div class="c-article-section__figure-description"><p>Estimate <img src="https://example.test/IEq1.jpg"> remains positive.</p>
    <p><a href="/slide">PowerPoint slide</a></p></div></figure>
    <figure><img src="https://example.test/Fig2.png" alt="Figure 2"><figcaption>Figure 2. Second result.</figcaption></figure>
    </section></div></div></article>
    """
    markdown = springer_html.extract_html_payload(
        html, "https://www.nature.com/articles/example"
    )["markdown_text"]
    assert markdown.count("https://example.test/Fig1.png") == 1
    assert markdown.count("https://example.test/Fig2.png") == 1
    assert markdown.count("https://example.test/IEq1.jpg") == 1
    assert (
        markdown.index("First result")
        < markdown.index("IEq1.jpg")
        < markdown.index("Fig2.png")
    )
    assert "PowerPoint slide" not in markdown


def test_springer_box_image_keeps_its_own_url_before_numbered_figures():
    html = """
    <article><div class="c-article-body"><div class="main-content"><section data-title="Results">
    <h2>Results</h2><div class="c-article-box" data-expandable-box-container="true">
    <div data-expandable-box="true" aria-hidden="true"><h3>Box 1 Terms</h3>
    <div class="c-article-box__content"><img src="https://example.test/box.png" alt=""></div></div></div>
    <figure><img src="https://example.test/Fig1.png" alt="Figure 1"><figcaption>Figure 1. Result.</figcaption></figure>
    </section></div></div></article>
    """
    markdown = springer_html.extract_html_payload(
        html, "https://www.nature.com/articles/example"
    )["markdown_text"]
    assert markdown.count("https://example.test/box.png") == 1
    assert markdown.count("https://example.test/Fig1.png") == 1
    assert (
        markdown.index("Box 1 Terms")
        < markdown.index("box.png")
        < markdown.index("Fig1.png")
    )
