...
- Sample ID: `10.1016_j.envres.2018.12.059`
- Fixture purpose: `table`
- Markdown to review: `tests/fixtures/golden_criteria/10.1016_j.envres.2018.12.059/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.1016_j.envres.2018.12.059/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.1016_j.envres.2018.12.059/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1016/j.envres.2018.12.059",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.1016_j.envres.2018.12.059/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.1016_j.envres.2018.12.059/markdown-quality-prompt.md",
  "provider": "elsevier",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1016_j.envres.2018.12.059",
  "schema_version": 2,
  "status": "pass"
}
```
