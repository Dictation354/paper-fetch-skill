...
- Sample ID: `10.1016_j.apgeog.2012.04.006`
- Fixture purpose: `table`
- Markdown to review: `tests/fixtures/golden_criteria/10.1016_j.apgeog.2012.04.006/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.1016_j.apgeog.2012.04.006/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.1016_j.apgeog.2012.04.006/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1016/j.apgeog.2012.04.006",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.1016_j.apgeog.2012.04.006/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.1016_j.apgeog.2012.04.006/markdown-quality-prompt.md",
  "provider": "elsevier",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1016_j.apgeog.2012.04.006",
  "schema_version": 2,
  "status": "pass"
}
```
