...
- Sample ID: `10.1073_pnas.2305050120`
- Markdown to review: `tests/fixtures/golden_criteria/10.1073_pnas.2305050120/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.1073_pnas.2305050120/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.1073_pnas.2305050120/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1073/pnas.2305050120",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.1073_pnas.2305050120/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.1073_pnas.2305050120/markdown-quality-prompt.md",
  "provider": "pnas",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1073_pnas.2305050120",
  "schema_version": 2,
  "status": "pass"
}
```
