...
Write-Host "Camoufox is not downloaded during installation. CLI browser requests can prepare it on demand; MCP/library requests default off."
Write-Host "Fully offline hosts must preinstall the complete Camoufox runtime and run browser-preflight while online."
